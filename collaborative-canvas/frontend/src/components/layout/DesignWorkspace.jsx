...
width: "220px",
  ...
  >
      ...
      <div
        ...
        />
       <div style={{ height: "85%", width: "100%", display: 'grid', marginTop: "0.75em", gridTemplateRows: '1fr 1fr' }}>
      <div style={{ display: 'grid', height: "2em", gridTemplateColumns: '33.33% 33.33% 33.33%'}}>
        <div onClick={handleBackToOrigin} style={{display: "flex", justifyContent: "center", alignItems: "center"}}><button
            title="Back to Origin"
            style={{height:"100%", width: "100%"}} className="custom-button"
          >
        ...
        <div style={{display: "flex", justifyContent: "center", alignItems: "center"}}><button onClick={handleToggleComments} title="Add Comment" 
              className={isAddingComments ? "active custom-button" : "custom-button"} 
...
width: "fit-content",
    ...
    padding: "13px",
      zIndex: 99,
    }}><NoteKeywordInput addKeywordSelection={addKeywordSelection} /></div>}
